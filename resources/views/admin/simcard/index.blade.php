...
<!--                 <a href="{{route('admin.simcard.change.agent')}}" class="btn btn-warning btn-sm">Сменить агента</a> -->
                ...
                <a href="{{route('admin.simcard.index')}}" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalDefault">Филтер</a>
                <a href="{{route('admin.simcard.create.mass')}}" class="btn btn-success btn-sm" >Добавить симкарты</a>
                <a href="{{route('admin.simcard.index')}}" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#importBlade">Импортировать симкарты</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{route('admin.simcard.import.mass')}}" id="import" enctype="multipart/form-data">
                                            <div class="custom-file">
                                                <label class="custom-file-label" for="excel">Выберите файл</label>
                                                <input type="file" name="excel" class="custom-file-input form-control" id="excel">
                                            </div>
                                        </form>
                                    </div>
                                </div>
